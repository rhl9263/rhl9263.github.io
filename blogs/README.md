...
Source-of-truth Markdown for posts published to [kumarrahul.whiz.pub](https://kumarrahul.whiz.pub).
...
- Markdown body below.
- **The `slug` in frontmatter becomes the URL** on whiz.pub — `https://kumarrahul.whiz.pub/<slug>`.
...
3. `python3 scripts/publish-to-whiz.py blogs/…md` — goes live at `https://kumarrahul.whiz.pub/<slug>`.
